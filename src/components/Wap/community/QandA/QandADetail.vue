...
//          console.log(res.data);
          if(this.args.currentPage === 1){
            ...
            this.$store.commit('SAVE_SHARE_DATA',{title:this.detailData.userName + "发表了问答:",desc:this.detailData.faqQuestionTitle,link:window.location.href,imgUrl:null,momentContentId:this.$route.query.faqQuestionId,momentName:'问答'});
