<template>
  <div>
    ...
    <div class="bg-abc"></div>
    <div class="bg-txt"></div>
    <div class="register-title"><i class="line"></i><span>立即加盟</span><i class="line"></i></div>
    <div class="form-wrap-sinvite">
...
.bg-logo{
  ...
  width: 100%;
  height: px2vw(174);
  background-image: url(../../../images/mine/logo.jpg);
  background-size: px2vw(380) auto;
...
.bg-abc{
  width: 100%;
  height: px2vw(361);
  background-image: url(../../../images/saleman/invite-sale.png);
  background-size: px2vw(711) auto;
  background-repeat: no-repeat;
  background-position: center;
}
.bg-txt{
  ...
  width: 100%;
  height: px2vw(152);
  background-image: url(../../../images/saleman/invite-txt.png);
  background-size: px2vw(710) auto;
  background-repeat: no-repeat;
  background-position: center;
}
.register-title{
  margin: px2vw(60) 0 px2vw(17) 0;
  text-align: center;
  span{
    height: px2vw(34);
